      ...
      >
        ...
        <div className="w-full h-auto hover:bg-[#221d41] rounded-[8px] flex flex-row py-[13px] px-[15px] ">
          ...
          <div className=" flex flex-col">
            ...
            <p className=" mt-[5px] text-[14px] text-gray-300 ">
              Get valuable insights and updates about how to better protect your data and network resources using quantum technology and artifical intelligence. 
            </p>
          </div>
        </div>
        <Link
        ...
        >
          ...
          <div className=" flex flex-col">
            ...
            <p className=" mt-[5px] text-[14px] text-gray-300 ">
              Learn more about our comapny values, teams and mission.
            </p>
          </div>
        </Link>
        <a
        ...
        >
          ...
          <div className=" flex flex-col">
            ...
            <p className=" mt-[5px] text-[14px] text-gray-300 ">
              Subscribe to my YouTube channel dedicated to teaching about everything quantum computing related!
            </p>
          </div>
        </a>
        <div className="w-full h-auto hover:bg-[#221d41] rounded-[8px] flex flex-row py-[13px] px-[15px] ">
