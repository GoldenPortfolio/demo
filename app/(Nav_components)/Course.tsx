...
function Course() {
  ...
  return (
    <div className="Nav_text flex flex-row group relative group ">
      <div onClick={() => setopen(true)} className=" text-white-300 flex flex-row">
        Products
        <ChevronDownIcon className=" w-[18px] h-[18px]  text-gray-300 translate-y-[2px] group-hover:text-[#e6dcdc9e] group-hover:text-gray-50 ml-[10px]" />
      </div>
        ...
        <div className="w-full h-auto hover:bg-[#221d41] rounded-[8px] flex flex-row py-[13px] px-[15px] ">
          ...
          <div className=" flex flex-col">
            <span className=" font-bold text-gray-200 text-[16px] hover:underline ">
              Quantum Shield V3 Software
            </span>
            <p className=" mt-[5px] text-[14px] text-gray-300 ">
              A lightweight quantum cybersecuirty solution that blocks ransomware, DDoS attacks, backdoors and protects vital data on servers. 
            </p>
          </div>
        </div>
      </div>
